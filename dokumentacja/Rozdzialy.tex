...
Jest to platforma umo¿liwiaj¹ca czat z pielêgniarkami lub lekarzami wybranych specjalizacji w wyznaczonym czasie kiedy s¹ dostêpni (Rys.~\ref{l:rynek3}).
...
Jest to platforma umo¿liwiaj¹ca umówienie siê na konsultacje z wybranym specjalist¹ które odbêd¹ siê za pomoc¹ menad¿era lub facebooka (Rys.~\ref{l:rynek4}).
